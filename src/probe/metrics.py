"""Bootstrap statistics. No t-tests, no normality assumption."""
...
def effect_size_pp(
    ...
    Positive number = injection reduced the mistake rate. Sign convention is
    fixed so that 'good for the hypothesis' is positive.
    """
